...
class TrackObject : public Object, public Consumer<LightSensorDataPacket>, public Productor<LightSensorDataPacket> {
  ...
  private:
    ...
    cv::Matx31d rvecTrack; //rotation vector from the model coordinate system to the camera coordinate system.
    cv::Matx31d tvecTrack;

    std::vector<cv::Point3d> vertices_;//the coordinate of infrared laser receiver 
